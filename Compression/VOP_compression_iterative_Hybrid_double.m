function VOP_compression_iterative_Hybrid_double(filename_in,eps_G,R,Sglobal,name_VOP,use_Sglobal,max_num_VOPs,max_iter)
...
use_GPU=true; %Activate or deactivate the use of GPU. If set to "false" The algorithm will be run on CPU completely.
